  ...
  <div class="w-full">
        ...
        <div data-aos="fade-right" class="col-span-12 lg:col-span-6 mt-4 xl:mt-20 space-y-6 px-4">
          ...
          <div class="space-y-6 lg:pr-12">
            <Exchange
              name="Amount"
              value="5.000"
              :exchange-selected="state.currencySelected"
              :exchanges="state.currencies"
            />
            <Exchange
              name="Get"
              value="0.10901"
              :exchange-selected="state.cryptoSelected"
              :exchanges="state.cryptocurrencies"
            />
            <Button class="w-full px-5 py-4 bg-blue-gradient text-white text-base font-medium">Buy Now</Button>
          </div>
        </div>
      ...
      <div class="relative max-w-screen-xl px-4 sm:px-2 mx-auto grid grid-cols-12 gap-x-6">
        ...
        <div data-aos="fade-right" class="col-span-12 lg:col-span-6 space-y-8 sm:space-y-6 px-4 sm:px-6 mt-8">
          ...
          <div class="flex flex-col sm:flex-row">
            <Button class="px-10 py-4 bg-inherit text-gradient border border-[#4A8FF6] text-base">
              Get Started
            </Button>
    ...
    <section class="bg-trading-tools relative max-w-full sm:mx-4 xl:mx-10 my-24 shadow sm:rounded-2xl overflow-hidden">
      <div class="w-full py-16 flex flex-col items-center">
        ...
        >
          <Step v-for="step in state.steps" :key="step.title" :step="step" />
          <img
    ...
    <section class="w-full my-24">
      <Section>
        ...
        <div data-aos="fade-left" data-aos-delay="150" class="col-span-12 lg:col-span-6 px-4 sm:px-6 mt-8">
          ...
          <ul class="shadow-box">
            <Accordion v-for="(accordion, index) in state.accordions" :key="index" :accordion="accordion" />
          </ul>
        </div>
      </Section>
    </section>
